...
#loading images
boatImg=pygame.image.load(r'images\boat.png')
bgImg=pygame.image.load(r'images\bg1.png')
mImg=pygame.image.load(r'images\missionary.png')
cImg=pygame.image.load(r'images\cannibal.png')
c1Img=pygame.image.load(r'images\cannibal1.png')
m1Img=pygame.image.load(r'images\missionary1.png')
ngImg=pygame.image.load(r'images\newgame.png')
ng1Img=pygame.image.load(r'images\newgame1.png')
gameoverImg=pygame.image.load(r'images\gameover.png')
wonImg=pygame.image.load(r'images\winner.png')
goImg=pygame.image.load(r'images\go.png')
go1Img=pygame.image.load(r'images\go1.png')
soundonImg=pygame.image.load(r'images\soundon.png')
soundoffImg=pygame.image.load(r'images\soundoff.png')
gameoversd = pygame.mixer.Sound(r'music\gameover.wav')
wonsd = pygame.mixer.Sound(r'music\won.wav')
...
def main():
    ...
    pygame.mixer.music.load(r'music\bgmusic.mp3')
